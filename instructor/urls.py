...
from .views import  instructor_view, instructorRegisterView, courseCreate, descriveCourseCreateView, courseCurriculum, courseIntendedLernerView, courseLandingPageView, coursePricingView, courseMessagesView, lectureDelete, previewCourseView, course_buyers, showReviewModelInstructor
...
urlpatterns = [
    ...
    path('course-buyers/', course_buyers, name='course_buyers'),
    path('find-review/<int:user_id>/<int:course_id>/', showReviewModelInstructor, name='review_find'),
